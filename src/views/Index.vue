          ...
          <div class="flex items-center justify-center min-h-screen bg-gray-800">
            <div class="w-full text-center mt-5">
              <div class="sm:pt-0">
                ...
                <p class="mt-4 text-2xl font-bold leading-relaxed text-white">
                  En ADN Creativo, somos especialistas en marketing digital y
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bgcafe">
              ...
              <blockquote class="relative p-8 mb-4">
                ...
                <p class="text-md font-light mt-2 text-white">
                  Ofrecemos paquetes especializados para obtener mayor alcance
                  en redes sociales. Generamos contenido de calidad para tu
              ...
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      La imagen profesional que merece y destaca en todas las
                      plataformas
                    </p>
                  </div>
                </div>
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      Transformamos tu música en una experiencia visual
                      completa.
                    </p>
                  </div>
                </div>
              ...
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col min-w-0 mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      La información correcta puede marcar la diferencia entre
                ...
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      ¡Lleva tu presencia online a otro nivel con las
                      estrategias de diseño de posts
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="container mx-auto">
        <div class="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10">
          <div class="w-full text-center lg:w-8/12">
            ...
            <img src="/src/assets/img/Vipromor.svg" alt="" srcset="">
